...
def manageApplications(request):
    ...
    esPath = '/home/foxitipanel/elasticsearch'
    rPath = '/home/foxitipanel/redis'
        ...
        try:
            ...
            if appName == 'Elasticsearch':
                if status == 'Installing':
                    command = '/usr/local/FoxitiCP/bin/python /usr/local/FoxitiCP/manageServices/serviceManager.py --function InstallElasticSearch'
                else:
                    command = '/usr/local/FoxitiCP/bin/python /usr/local/FoxitiCP/manageServices/serviceManager.py --function RemoveElasticSearch'
            elif appName == 'Redis':
                if status == 'Installing':
                    command = '/usr/local/FoxitiCP/bin/python /usr/local/FoxitiCP/manageServices/serviceManager.py --function InstallRedis'
                else:
                    command = '/usr/local/FoxitiCP/bin/python /usr/local/FoxitiCP/manageServices/serviceManager.py --function RemoveRedis'
