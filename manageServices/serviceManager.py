...
class ServiceManager:
    ...
    slaveConfPath = '/home/foxitipanel/slaveConf'
...
'''
        ...
        command = 'touch /home/foxitipanel/elasticsearch'
        ServerStatusUtil.executioner(command, statusFile)
    ...
    def RemoveElasticSearch():
        ...
        command = 'rm -f /home/foxitipanel/elasticsearch'
        ServerStatusUtil.executioner(command, statusFile)
    ...
    def InstallRedis():
        ...
        command = 'touch /home/foxitipanel/redis'
        ServerStatusUtil.executioner(command, statusFile)
    ...
    def RemoveRedis():
        ...
        command = 'rm -f /home/foxitipanel/redis'
        ServerStatusUtil.executioner(command, statusFile)
...
def main():
    ...
    parser = argparse.ArgumentParser(description='foxitiPanel Application Manager')
