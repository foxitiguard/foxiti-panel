# OS Compatibility Guide - foxitiPanel Test Plugin

## 🌐 Supported Operating Systems

The foxitiPanel Test Plugin is designed to work seamlessly across all foxitiPanel-supported operating systems with comprehensive multi-OS compatibility.
...
# Web Server: apache2
# User/Group: foxitipanel:foxitipanel
```
...
chcon -R -t httpd_exec_t /usr/local/FoxitiCP/testPlugin/
```
...
cd /usr/local/FoxitiCP/testPlugin
...
### Sample Output
```
🔍 Testing OS Compatibility for foxitiPanel Test Plugin
============================================================
...
🔐 Testing File Permissions...
   ✅ Plugin Directory: /home/foxitipanel/plugins
   ✅ foxitiPanel Directory: /usr/local/FoxitiCP

🌍 Testing Network Connectivity...
   ✅ GitHub: True
   ✅ Internet: True

⚡ Testing foxitiPanel Integration...
   ✅ foxitiPanel Installed: True
   ✅ Settings File: True
   ✅ URLs File: True
   ✅ LSCPD Service: True
...
# Permission denied
sudo chown -R foxitipanel:foxitipanel /home/foxitipanel/plugins
sudo chown -R foxitipanel:foxitipanel /usr/local/FoxitiCP/testPlugin
...
sudo chcon -R -t httpd_exec_t /usr/local/FoxitiCP/testPlugin/
...
ls -la /home/foxitipanel/plugins/
ls -la /usr/local/FoxitiCP/testPlugin/

# Check foxitiPanel logs
tail -f /home/foxitipanel/logs/foxitipanel.log
tail -f /home/foxitipanel/logs/django.log
```
...
- [ ] Ensure foxitiPanel is installed and running
...
# Or manually remove
sudo rm -rf /usr/local/FoxitiCP/testPlugin
sudo rm -f /home/foxitipanel/plugins/testPlugin
```
...
### Plugin Support
- **GitHub Issues**: https://github.com/foxitipanel/testPlugin/issues
- **foxitiPanel Forums**: https://forums.foxitipanel.net/
- **Documentation**: https://foxitipanel.net/docs/
