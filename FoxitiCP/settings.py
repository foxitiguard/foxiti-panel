"""
Django settings for FoxitiCP project.
...
if not SECRET_KEY:
    _secret_key_path = os.getenv('FOXITIPANEL_SECRET_KEY_FILE', '/usr/local/FoxitiCP/secret_key')
    try:
...
SESSION_COOKIE_NAME = 'foxitipanel_sessionid'
...
MIDDLEWARE = [
    ...
    'FoxitiCP.secMiddleware.secMiddleware'
]

ROOT_URLCONF = 'FoxitiCP.urls'
...
WSGI_APPLICATION = 'FoxitiCP.wsgi.application'
...
DATABASES = {
    'default': {
        ...
        'NAME': os.getenv('DB_NAME', 'foxitipanel'),
        'USER': os.getenv('DB_USER', 'foxitipanel'),
...
MEDIA_URL = '/usr/local/FoxitiCP/tmp/'
