...
app.controller('listEmails', function ($scope, $http) {
    ...
    $scope.populateCurrentRecords = function () {
        $scope.foxitipanelLoading = true;  // Show loading while fetching
        $scope.emailsAccounts = true;
        ...
        function ListInitialDatas(response) {
            $scope.foxitipanelLoading = false;  // Hide loading when done
        ...
        function cantLoadInitialDatas(response) {
            $scope.foxitipanelLoading = false;  // Hide loading on error
            $scope.emailsAccounts = true;
            new PNotify({
                title: 'Error!',
    ...
    $scope.deleteEmailAccountFinal = function (email) {
        ...
        $scope.foxitipanelLoading = true;  // Show loading while deleting
    ...
    $scope.fixMailSSL = function (email) {
        ...
        $scope.foxitipanelLoading = true;  // Show loading while fixing SSL
