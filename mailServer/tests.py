...
class TestMailServer(TestCase):
    ...
    def MakeRequest(self, endPoint, data):
        ...
        path = 'https://foxitipanel.xyz:8090/%s' % (endPoint)
    ...
    def setUp(self):
        ...
        data_ret = {'virtualHost': 'foxitipanel.xyz'}
    ...
    def test_submitEmailCreation(self):
        ...
        data_ret = {'domain': 'foxitipanel.xyz', 'username':'helloworld', 'passwordByPass':'helloworld'}
        ...
        try:
            ok = 1
            smtpServer = smtplib.SMTP('foxitipanel.xyz', 25)
            smtpServer.login('helloworld@foxitipanel.xyz', 'helloworld')

            message = MIMEMultipart('alternative')
            message['Subject'] = 'Test Email'
            message['From'] = 'Unit Test' + ' ' + 'helloworld@foxitipanel.xyz'
            message['reply-to'] = 'helloworld@foxitipanel.xyz'
        ...
        data_ret = {'email': 'helloworld@foxitipanel.xyz'}
