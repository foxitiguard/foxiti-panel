...
def main():
    ...
    try:
        ...
        elif os.path.isfile('/usr/bin/foxitipanel') | os.path.isfile(os.getcwd() + '/foxitipanel'):
    ...
    if username == 'root' and controlpanel == 'foxitiPanel':
        # Needs updated to glob all /home/*/logs/
        path = '/home/*/logs/*'
        domlogs_path = glob.glob("/home/*/logs/")
        print('Root foxitiPanel Detected')
    ...
    if controlpanel == 'Cpanel' or controlpanel == 'foxitiPanel':
