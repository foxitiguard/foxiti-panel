...
## Objective Fix permissions issues on foxitiPanel/cPanel/Plesk for a linux user or users
...
elif [ -f /usr/bin/foxitipanel ]; then
    	# foxitiPanel check /usr/bin/foxitipanel
    	ControlPanel="foxitipanel"
...
fixperms () {
	...
	elif [ "${ControlPanel}" == "foxitipanel" ] ; then

		fixperms_foxitipanel "${Username}"
		fixmailperms_foxitipanel
