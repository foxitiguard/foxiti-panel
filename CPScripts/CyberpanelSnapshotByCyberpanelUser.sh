...
## https://gitlab.com/foxitipaneltoolsnscripts/snapshotbyfoxitipaneluser
## How to use.
# ./CyberpanelSnapshotByCyberpanelUser.sh username
#./CyberpanelSnapshotCyberpanelUser.sh exampleuserbob
#
##bash <(curl -s https://gitlab.com/foxitipaneltoolsnscripts/snapshotbyfoxitipaneluser/-/raw/master/CyberpanelSnapshotByCyberpanelUser.sh || wget -qO - https://gitlab.com/foxitipaneltoolsnscripts/snapshotbyfoxitipaneluser/-/raw/master/CyberpanelSnapshotByCyberpanelUser.sh) exampleuserbob;
##
Username=$1
