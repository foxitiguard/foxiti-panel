# foxitiPanel OpenLiteSpeed Module - Complete Usage Guide
...
12. [foxitiPanel Integration](#foxitipanel-integration)
...
The foxitiPanel OpenLiteSpeed Module brings Apache .htaccess compatibility to OpenLiteSpeed servers. It allows you to use familiar Apache directives without switching web servers.

### Quick Start

1. **Module is pre-installed** on foxitiPanel servers
...
### foxitiPanel Integration

#### Via File Manager

1. Log into **foxitiPanel**
...
1. Create subdomain `staging.yourdomain.com` in foxitiPanel
...
#### Protect foxitiPanel Access

```apache
# In /usr/local/FoxitiCP/public/.htaccess (if web accessible)
Order deny,allow
Deny from all
...
**Solution:**
1. Verify module loaded: `ls -la /usr/local/lsws/modules/foxitipanel_ols.so`
...
**Steps:**
1. Keep old domain active in foxitiPanel
...
- foxitiPanel uses LSPHP by default ✅
...
```bash
# Check module loaded
ls -la /usr/local/lsws/modules/foxitipanel_ols.so
...
#### Via foxitiPanel File Manager

1. Log into **foxitiPanel** (https://yourserver:8090)
...
1. **Create Website** in foxitiPanel
...
grep foxitipanel_ols /usr/local/lsws/conf/httpd_config.conf
# Should show: module foxitipanel_ols {
...
grep "foxitipanel_access" /usr/local/lsws/logs/error.log
...
```bash
# Module version
ls -lh /usr/local/lsws/modules/foxitipanel_ols.so
...
- **GitHub:** [github.com/usmannasir/foxitipanel_ols](https://github.com/usmannasir/foxitipanel_ols)
- **Community:** [community.foxitipanel.net](https://community.foxitipanel.net)
...
*Thank you for using the foxitiPanel OpenLiteSpeed Module!*
