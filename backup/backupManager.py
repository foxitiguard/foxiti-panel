...
from foxitipanel_version import version_at_least

class BackupManager:
    localBackupPath = '/home/foxitipanel/localBackupPath'
    ...
    def changeFileRetention(self, request=None, userID=None, data=None):
        try:
            ...
            # logging.FoxitiCPLogFileWriter.writeToFile("...... FileRetentiontime...%s "%Retentiontime)

            gD = GDrive.objects.get(name=selectedAccount)
            # logging.FoxitiCPLogFileWriter.writeToFile("...... GDrive obj...%s " % GDrive)
            ...
            conf = gD.auth
            # logging.FoxitiCPLogFileWriter.writeToFile("...... conf...%s " % conf)
            config = json.loads(conf)
            # logging.FoxitiCPLogFileWriter.writeToFile("...... config...%s " % config)
    ...
    def backupStatus(self, userID=None, data=None):
        try:
            ...
            final_json = json.dumps(final_dic)
            logging.FoxitiCPLogFileWriter.writeToFile(str(msg) + " [backupStatus]")
            return HttpResponse(final_json)
    ...
    def cancelBackupCreation(self, userID=None, data=None):
        try:
            ...
            execPath = "/usr/local/FoxitiCP/bin/python " + virtualHostUtilities.cyberPanel + "/plogical/backupUtilities.py"
            ...
            try:
                ...
                logging.FoxitiCPLogFileWriter.writeToFile(str(msg) + " [cancelBackupCreation]")
        ...
        try:
            ...
            if data['type'] == 'SFTP':
                ...
                if os.path.exists(ProcessUtilities.debugPath):
                    logging.FoxitiCPLogFileWriter.writeToFile(execPath)
    ...
    def scheduleBackup(self, request, userID=None, data=None):
        try:
            ...
            logging.FoxitiCPLogFileWriter.writeToFile(str(msg) + ' [scheduleBackup]')
    ...
    def scheduleDelete(self, userID=None, data=None):
        try:
            ...
            logging.FoxitiCPLogFileWriter.writeToFile(findTxt)
            logging.FoxitiCPLogFileWriter.writeToFile(backupFreq)

            path = "/etc/crontab"

            command = "cat " + path
            output = ProcessUtilities.outputExecutioner(command).split('\n')
            tempCronPath = "/home/foxitipanel/" + str(randint(1000, 9999))
    ...
    def submitRemoteBackups(self, userID=None, data=None):
        try:
            ...
            ## Ask for Remote version of foxitiPanel
            ...
            pathToKey = "/home/foxitipanel/" + str(randint(1000, 9999))
            ...
            execPath = "/usr/local/FoxitiCP/bin/python " + virtualHostUtilities.cyberPanel + "/plogical/remoteTransferUtilities.py"
    ...
    def starRemoteTransfer(self, userID=None, data=None):
        try:
            ...
            try:
                ...
                ipFile = os.path.join("/etc", "foxitipanel", "machineIP")
                ...
                if os.path.exists('/usr/local/FoxitiCP/debug'):
    ...
    def CreateV2BackupStatus(self, userID=None, data=None):
        try:
            ...
            statusFile = f'/home/foxitipanel/{domain}_rustic_backup_log'
            ...
            #currentStatus:"cat: /home/foxitipanel/9219: No such file or directory"
    ...
    def OneClickBackups(self, request=None, userID=None, data=None):
        ...
        try:
            if request.GET.get('status', 'none') == 'success':
                ...
                try:
                    ...
                    url = 'http://cp.foxitiguard.com/Billing/CreateSFTPAccount'  # Replace with your actual endpoint URL

                    # Define the payload to send in the POST request
                    payload = {
                        'sub': subscription,
                        'key': ProcessUtilities.outputExecutioner(f'cat /root/.ssh/foxitipanel.pub'),  # Replace with the actual SSH public key
        ...
        url = 'https://cp.foxitiguard.com/Billing/FetchBackupPlans'
    ...
    def ManageOCBackups(self, request=None, userID=None, data=None):
        ...
        try:
            import requests
            url = 'https://cp.foxitiguard.com/Billing/GetBackupStats'
            payload = {
            ...
            if response.status_code == 200:
                ...
                if api_data.get('status') == 1:
                    ...
                    logging.FoxitiCPLogFileWriter.writeToFile(f'Successfully fetched backup stats for {ocb.sftpUser} [ManageOCBackups]')
                else:
                    logging.FoxitiCPLogFileWriter.writeToFile(f'Platform API returned error: {api_data.get("error_message")} [ManageOCBackups]')
            else:
                logging.FoxitiCPLogFileWriter.writeToFile(f'Platform API returned HTTP {response.status_code} [ManageOCBackups]')
        except Exception as e:
            logging.FoxitiCPLogFileWriter.writeToFile(f'Failed to fetch backup stats: {str(e)} [ManageOCBackups]')
    ...
    def RestoreOCBackups(self, request=None, userID=None, data=None):
        try:
            ...
            logging.FoxitiCPLogFileWriter.writeToFile(str(msg) + ' [RestoreOCBackups]')
            return HttpResponse("Error: " + str(msg))
        ...
        try:
            ...
            logging.FoxitiCPLogFileWriter.writeToFile(f"Failed to get backup destination: {str(e)} [RestoreOCBackups]")
        ...
        try:
            ...
            if check_exists == "NOT_EXISTS":
                logging.FoxitiCPLogFileWriter.writeToFile(f"SSH key not found at {private_key_path} [RestoreOCBackups]")
            ...
            if not key_content or key_content.startswith('cat:'):
                logging.FoxitiCPLogFileWriter.writeToFile(f"Failed to read SSH key at {private_key_path} [RestoreOCBackups]")
            ...
            logging.FoxitiCPLogFileWriter.writeToFile(f"SSH Authentication failed: {str(e)} [RestoreOCBackups]")
            return HttpResponse("Error: SSH Authentication failed. Please check your One-click Backup configuration.")
        except paramiko.SSHException as e:
            logging.FoxitiCPLogFileWriter.writeToFile(f"SSH Connection failed: {str(e)} [RestoreOCBackups]")
            return HttpResponse(f"Error: Failed to connect to backup server: {str(e)}")
        except Exception as e:
            logging.FoxitiCPLogFileWriter.writeToFile(f"Unexpected error during SSH operation: {str(e)} [RestoreOCBackups]")
    ...
    def fetchOCSites(self, request=None, userID=None, data=None):
        ...
        try:
            ...
            try:
                ...
                logging.FoxitiCPLogFileWriter.writeToFile(f"OneClickBackup with id {id} not found for user {userID} [fetchOCSites]")
            ...
            try:
                ...
                logging.FoxitiCPLogFileWriter.writeToFile(f"Backup destination {ocb.sftpUser} not found [fetchOCSites]")
                data_ret = {'status': 0, 'error_message': 'Backup destination not configured. Please deploy your backup account first.'}
                return HttpResponse(json.dumps(data_ret))
            except (KeyError, json.JSONDecodeError) as e:
                logging.FoxitiCPLogFileWriter.writeToFile(f"Invalid backup destination config for {ocb.sftpUser}: {str(e)} [fetchOCSites]")
            ...
            if check_exists == "NOT_EXISTS":
                logging.FoxitiCPLogFileWriter.writeToFile(f"SSH key not found at {private_key_path} [fetchOCSites]")
            ...
            if not key_content or key_content.startswith('cat:'):
                logging.FoxitiCPLogFileWriter.writeToFile(f"Failed to read SSH key at {private_key_path} [fetchOCSites]")
                ...
                try:
                    ...
                    try:
                        ...
                        try:
                            ...
                            logging.FoxitiCPLogFileWriter.writeToFile(f"Failed to load SSH key: {str(e)} [fetchOCSites]")
            ...
            try:
                ...
                logging.FoxitiCPLogFileWriter.writeToFile(f"SSH Authentication failed for {ocb.sftpUser}@{ip}: {str(e)} [fetchOCSites]")
                ...
                logging.FoxitiCPLogFileWriter.writeToFile(f"SSH Connection failed to {ip}: {str(e)} [fetchOCSites]")
                ...
                logging.FoxitiCPLogFileWriter.writeToFile(f"Unexpected SSH error connecting to {ip}: {str(e)} [fetchOCSites]")
            ...
            try:
                ...
                for directory in directories:
                    if directory and '/' in directory:
                        try:
                            ...
                            logging.FoxitiCPLogFileWriter.writeToFile(f"Failed to parse directory path '{directory}': {str(e)} [fetchOCSites]")
                            continue
                ...
                logging.FoxitiCPLogFileWriter.writeToFile(f"Failed to execute command on remote server: {str(e)} [fetchOCSites]")
                data_ret = {'status': 0, 'error_message': f'Failed to list backups: {str(e)}'}
                return HttpResponse(json.dumps(data_ret))

        except json.JSONDecodeError as e:
            logging.FoxitiCPLogFileWriter.writeToFile(f"Invalid JSON in request: {str(e)} [fetchOCSites]")
            data_ret = {'status': 0, 'error_message': 'Invalid request format.'}
            return HttpResponse(json.dumps(data_ret))
        except KeyError as e:
            logging.FoxitiCPLogFileWriter.writeToFile(f"Missing required field in request: {str(e)} [fetchOCSites]")
            data_ret = {'status': 0, 'error_message': f'Missing required field: {str(e)}'}
            return HttpResponse(json.dumps(data_ret))
        except Exception as msg:
            logging.FoxitiCPLogFileWriter.writeToFile(f"Unexpected error in fetchOCSites: {str(msg)}")
    ...
    def StartOCRestore(self, request=None, userID=None, data=None):
        try:
            ...
            extraArgs['tempStatusPath'] = "/home/foxitipanel/" + str(randint(1000, 9999))
    ...
    def DeployAccount(self, request=None, userID=None, data=None):
        ...
        try:
            ...
            try:
                ...
                logging.FoxitiCPLogFileWriter.writeToFile(f"Invalid request data in DeployAccount: {str(e)}")
                return HttpResponse(json.dumps({
                    'status': 0,
            ...
            try:
                ...
                logging.FoxitiCPLogFileWriter.writeToFile(f"OneClickBackup {backup_id} not found for user {userID} [DeployAccount]")
                return HttpResponse(json.dumps({
                    'status': 0,
            ...
            if ocb.state == 1:
                logging.FoxitiCPLogFileWriter.writeToFile(f"Backup plan {backup_id} already deployed [DeployAccount]")
                return HttpResponse(json.dumps({
                    'status': 1,
            ...
            # Read SSH public key
            try:
                ssh_pub_key = ProcessUtilities.outputExecutioner('cat /root/.ssh/foxitipanel.pub').strip()
                if not ssh_pub_key or ssh_pub_key.startswith('cat:'):
                    raise Exception("Failed to read SSH public key")
            except Exception as e:
                logging.FoxitiCPLogFileWriter.writeToFile(f"Failed to read SSH public key: {str(e)} [DeployAccount]")
                return HttpResponse(json.dumps({
                    'status': 0,
            ...
            # Prepare API request
            url = 'https://cp.foxitiguard.com/Billing/CreateSFTPAccount'
            payload = {
                'sub': ocb.subscription,
                'key': ssh_pub_key,
                'sftpUser': ocb.sftpUser,
            ...
            try:
                ...
                logging.FoxitiCPLogFileWriter.writeToFile(f"API request failed: {str(e)} [DeployAccount]")
                return HttpResponse(json.dumps({
                    'status': 0,
            ...
            if response.status_code != 200:
                logging.FoxitiCPLogFileWriter.writeToFile(f"API returned status {response.status_code}: {response.text} [DeployAccount]")
                return HttpResponse(json.dumps({
                    'status': 0,
            ...
            try:
                ...
                logging.FoxitiCPLogFileWriter.writeToFile(f"Invalid JSON response from API: {response.text} [DeployAccount]")
                return HttpResponse(json.dumps({
                    'status': 0,
            ...
            if api_status == 1 or api_error == "Already deployed.":
                ...
                logging.FoxitiCPLogFileWriter.writeToFile(f"SFTP account {deployment_status} for {ocb.sftpUser} [DeployAccount]")
                ...
                try:
                    ...
                    logging.FoxitiCPLogFileWriter.writeToFile(f"Failed to create destination: {str(e)} [DeployAccount]")
                    return HttpResponse(json.dumps({
                        'status': 0,
                ...
                logging.FoxitiCPLogFileWriter.writeToFile(f"API returned error: {api_error} [DeployAccount]")
                return HttpResponse(json.dumps({
                    'status': 0,
            ...
            logging.FoxitiCPLogFileWriter.writeToFile(f"Unexpected error in DeployAccount: {str(e)}")
            return HttpResponse(json.dumps({
                'status': 0,
    ...
    def ReconfigureSubscription(self, request=None, userID=None, data=None):
        try:
            ...
            url = 'http://cp.foxitiguard.com/Billing/ReconfigureSubscription'
            
            payload = {
                'subscription_id': subscription_id,
                'key': ProcessUtilities.outputExecutioner(f'cat /root/.ssh/foxitipanel.pub'),
                'serverIP': ACLManager.fetchIP(),
                'email': data['email'],
                'code': data['code']
            }
            ...
            if response.status_code == 200:
                ...
                if response_data.get('status') == 1:
                    ...
                    # Create SFTP destination in foxitiPanel
                    finalDic = {
                        'IPAddress': response_data.get('ipAddress'),
                        'password': 'NOT-NEEDED',
                        'backupSSHPort': '22',
