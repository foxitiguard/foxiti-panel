...
def get_foxitipanel_version():
    with open('/usr/local/FoxitiCP/version.txt') as version:
...
def main():
    ...
    foxitipanel = cyberPanel()

    ## Website functions

    if args.function == "createWebsite":

        completeCommandExample = 'foxitipanel createWebsite --package Detault --owner admin --domainName foxitipanel.net --email support@foxitipanel.net --php 5.6'
        ...
        foxitipanel.createWebsite(args.package, args.owner, args.domainName, args.email, args.php, ssl, dkim,
                                 openBasedir)
    elif args.function == "deleteWebsite":

        completeCommandExample = 'foxitipanel deleteWebsite --domainName foxitipanel.net'

        if not args.domainName:
            print("\n\nPlease enter the domain to delete. For example:\n\n" + completeCommandExample + "\n\n")
            return

        foxitipanel.deleteWebsite(args.domainName)
    elif args.function == "createChild":

        completeCommandExample = 'foxitipanel createChild --masterDomain foxitipanel.net --childDomain child.foxitipanel.net' \
                                 ' --owner admin --php 5.6'
        ...
        foxitipanel.createDomain(args.masterDomain, args.childDomain, args.owner, args.php, ssl, dkim, openBasedir, path)
    elif args.function == "deleteChild":

        completeCommandExample = 'foxitipanel deleteChild --childDomain foxitipanel.net'

        if not args.childDomain:
            print("\n\nPlease enter the child domain to delete. For example:\n\n" + completeCommandExample + "\n\n")
            return

        foxitipanel.deleteChild(args.childDomain)
    elif args.function == "listWebsitesJson":
        foxitipanel.listWebsitesJson()
    elif args.function == "listWebsitesPretty":
        foxitipanel.listWebsitesPretty()

    elif args.function == "changePHP":

        completeCommandExample = 'foxitipanel changePHP --domainName foxitipanel.net --php 5.6'
        ...
        foxitipanel.changePHP(args.domainName, args.php)
    elif args.function == "changePackage":

        completeCommandExample = 'foxitipanel changePackage --domainName foxitipanel.net --packageName CLI'
        ...
        foxitipanel.changePackage(args.domainName, args.packageName)

    ## DNS Functions

    elif args.function == "listDNSJson":

        completeCommandExample = 'foxitipanel listDNSJson --domainName foxitipanel.net'

        if not args.domainName:
            print("\n\nPlease enter the domain. For example:\n\n" + completeCommandExample + "\n\n")
            return

        foxitipanel.listDNSJson(args.domainName)
    elif args.function == "listDNSPretty":

        completeCommandExample = 'foxitipanel listDNSPretty --domainName foxitipanel.net'

        if not args.domainName:
            print("\n\nPlease enter the domain. For example:\n\n" + completeCommandExample + "\n\n")
            return

        foxitipanel.listDNSPretty(args.domainName)
    elif args.function == "listDNSZonesJson":
        foxitipanel.listDNSZonesJson()
    elif args.function == "listDNSZonesPretty":
        foxitipanel.listDNSZonesPretty()
    elif args.function == "createDNSZone":
        completeCommandExample = 'foxitipanel createDNSZone --owner admin --domainName foxitipanel.net'
        ...
        foxitipanel.createDNSZone(args.domainName, args.owner)
    elif args.function == "deleteDNSZone":
        completeCommandExample = 'foxitipanel deleteDNSZone --domainName foxitipanel.net'

        if not args.domainName:
            print("\n\nPlease enter the domain. For example:\n\n" + completeCommandExample + "\n\n")
            return

        foxitipanel.deleteDNSZone(args.domainName)
    elif args.function == "createDNSRecord":
        completeCommandExample = 'foxitipanel createDNSRecord --domainName foxitipanel.net --name foxitipanel.net' \
        ...
        foxitipanel.createDNSRecord(args.domainName, args.name, args.recordType, args.value, args.priority, args.ttl)
    elif args.function == "deleteDNSRecord":
        completeCommandExample = 'foxitipanel deleteDNSRecord --recordID 200'
        ...
        foxitipanel.deleteDNSRecord(args.recordID)

    ## Backup Functions.

    elif args.function == "createBackup":

        completeCommandExample = 'foxitipanel createBackup --domainName foxitipanel.net'

        if not args.domainName:
            print("\n\nPlease enter the domain. For example:\n\n" + completeCommandExample + "\n\n")
            return

        foxitipanel.createBackup(args.domainName)
    elif args.function == "restoreBackup":

        completeCommandExample = 'foxitipanel restoreBackup --fileName /home/talkshosting.com/backup/backup-talksho-01-30-53-Fri-Jun-2018.tar.gz'

        if not args.fileName:
            print("\n\nPlease enter the file name or complete path to file. For example:\n\n" + completeCommandExample + "\n\n")
            return

        foxitipanel.restoreBackup(args.fileName)

    ## Package functions.

    elif args.function == "createPackage":

        completeCommandExample = 'foxitipanel createPackage --owner admin --packageName CLI --diskSpace 1000 --bandwidth 10000 --emailAccounts 100' \
        ...
        foxitipanel.createPackage(args.owner, args.packageName, args.diskSpace, args.bandwidth, args.emailAccounts,
                                 args.dataBases, args.ftpAccounts, args.allowedDomains)
    elif args.function == "deletePackage":
        completeCommandExample = 'foxitipanel deletePackage --packageName CLI'
        if not args.packageName:
            print("\n\nPlease enter the package name. For example:\n\n" + completeCommandExample + "\n\n")
            return

        foxitipanel.deletePackage(args.packageName)
    elif args.function == "listPackagesJson":
        foxitipanel.listPackagesJson()
    elif args.function == "listPackagesPretty":
        foxitipanel.listPackagesPretty()

    ## Database functions.

    elif args.function == "createDatabase":

        completeCommandExample = 'foxitipanel createDatabase --databaseWebsite foxitipanel.net --dbName foxitipanel ' \
                                 '--dbUsername foxitipanel --dbPassword foxitipanel'
        ...
        foxitipanel.createDatabase(args.dbName, args.dbUsername, args.dbPassword, args.databaseWebsite)
    elif args.function == "deleteDatabase":
        completeCommandExample = 'foxitipanel deleteDatabase --dbName foxitipanel'
        if not args.dbName:
            print("\n\nPlease enter the database name. For example:\n\n" + completeCommandExample + "\n\n")
            return

        foxitipanel.deleteDatabase(args.dbName)
    elif args.function == "listDatabasesJson":

        completeCommandExample = 'foxitipanel listDatabasesJson --databaseWebsite foxitipanel.net'

        if not args.databaseWebsite:
            print("\n\nPlease enter database website. For example:\n\n" + completeCommandExample + "\n\n")
            return
        foxitipanel.listDatabasesJson(args.databaseWebsite)
    elif args.function == "listDatabasesPretty":
        completeCommandExample = 'foxitipanel listDatabasesPretty --databaseWebsite foxitipanel.net'

        if not args.databaseWebsite:
            print("\n\nPlease enter database website. For example:\n\n" + completeCommandExample + "\n\n")
            return

        foxitipanel.listDatabasesPretty(args.databaseWebsite)

    ## Email Functions

    elif args.function == "createEmail":

        completeCommandExample = 'foxitipanel createEmail --domainName foxitipanel.net --userName foxitipanel ' \
                                 '--password foxitipanel'
        ...
        foxitipanel.createEmail(args.domainName, args.userName, args.password)
    elif args.function == "deleteEmail":
        completeCommandExample = 'foxitipanel deleteEmail --email foxitipanel@foxitipanel.net'

        if not args.email:
            print("\n\nPlease enter the email. For example:\n\n" + completeCommandExample + "\n\n")
            return

        foxitipanel.deleteEmail(args.email)
    elif args.function == "changeEmailPassword":

        completeCommandExample = 'foxitipanel changeEmailPassword --email foxitipanel@foxitipanel.net --password foxitipanel'
        ...
        foxitipanel.changeEmailPassword(args.email, args.password)
    elif args.function == "listEmailsJson":
        completeCommandExample = 'foxitipanel listEmailsJson --domainName foxitipanel.net'

        if not args.domainName:
            print("\n\nPlease enter domain name. For example:\n\n" + completeCommandExample + "\n\n")
            return

        foxitipanel.listEmailsJson(args.domainName)
    elif args.function == "listEmailsPretty":
        completeCommandExample = 'foxitipanel listEmailsPretty --domainName foxitipanel.net'

        if not args.domainName:
            print("\n\nPlease enter domain name. For example:\n\n" + completeCommandExample + "\n\n")
            return

        foxitipanel.listEmailsPretty(args.domainName)

    ## FTP Functions

    elif args.function == "createFTPAccount":

        completeCommandExample = 'foxitipanel createFTPAccount --domainName foxitipanel.net --userName foxitipanel ' \
                                 '--password foxitipanel --owner admin'
        ...
        foxitipanel.createFTPAccount(args.domainName, args.userName, args.password, args.owner)
    elif args.function == "deleteFTPAccount":
        completeCommandExample = 'foxitipanel deleteFTPAccount --userName foxitipanel'

        if not args.userName:
            print("\n\nPlease enter the user name. For example:\n\n" + completeCommandExample + "\n\n")
            return

        foxitipanel.deleteFTPAccount(args.userName)
    elif args.function == "changeFTPPassword":

        completeCommandExample = 'foxitipanel changeFTPPassword --userName foxitipanel --password foxitipanel'
        ...
        foxitipanel.changeFTPPassword(args.userName, args.password)
    elif args.function == "listFTPJson":
        completeCommandExample = 'foxitipanel listFTPJson --domainName foxitipanel.net'

        if not args.domainName:
            print("\n\nPlease enter domain name. For example:\n\n" + completeCommandExample + "\n\n")
            return

        foxitipanel.listFTPJson(args.domainName)
    elif args.function == "listFTPPretty":
        completeCommandExample = 'foxitipanel listFTPPretty --domainName foxitipanel.net'

        if not args.domainName:
            print("\n\nPlease enter domain name. For example:\n\n" + completeCommandExample + "\n\n")
            return

        foxitipanel.listFTPPretty(args.domainName)

    ## SSL Functions
    elif args.function == "issueSSL":
        completeCommandExample = 'foxitipanel issueSSL --domainName foxitipanel.net'

        if not args.domainName:
            print("\n\nPlease enter Domain name. For example:\n\n" + completeCommandExample + "\n\n")
            return

        foxitipanel.issueSSL(args.domainName)
    elif args.function == "hostNameSSL":
        completeCommandExample = 'foxitipanel hostNameSSL --domainName foxitipanel.net'

        if not args.domainName:
            print("\n\nPlease enter Domain name. For example:\n\n" + completeCommandExample + "\n\n")
            return

        foxitipanel.issueSSLForHostName(args.domainName)
    elif args.function == "mailServerSSL":

        completeCommandExample = 'foxitipanel mailServerSSL --domainName foxitipanel.net'

        if not args.domainName:
            print("\n\nPlease enter Domain name. For example:\n\n" + completeCommandExample + "\n\n")
            return

        foxitipanel.issueSSLForMailServer(args.domainName)

    elif args.function == "issueSelfSignedSSL":
        completeCommandExample = 'foxitipanel issueSelfSignedSSL --domainName foxitipanel.net'

        if not args.domainName:
            print("\n\nPlease enter Domain name. For example:\n\n" + completeCommandExample + "\n\n")
            return

        foxitipanel.issueSelfSignedSSL(args.domainName)

    elif args.function == 'utility':
        if not os.path.exists('/usr/bin/foxitipanel_utility'):
            command = 'wget -q -O /usr/bin/foxitipanel_utility https://foxitipanel.sh/misc/foxitipanel_utility.sh'
            ProcessUtilities.executioner(command)

            command = 'chmod 700 /usr/bin/foxitipanel_utility'
            ProcessUtilities.executioner(command)

        command = '/usr/bin/foxitipanel_utility'
        ProcessUtilities.executioner(command)
        ...
        command = '/usr/bin/foxitipanel_utility --upgrade'
        ProcessUtilities.executioner(command)
        ...
        command = '/usr/bin/foxitipanel_utility --help'
        ProcessUtilities.executioner(command)
    elif args.function == 'version' or args.function == 'v' or args.function == 'V':
        ## Get CurrentVersion
        print(get_foxitipanel_version())

    ### User Functions

    elif args.function == "createUser":

        completeCommandExample = 'foxitipanel createUser --firstName Cyber --lastName Panel --email email@foxitipanel.net --userName foxitipanel --password securepassword --websitesLimit 10 --selectedACL user --securityLevel HIGH'
        ...
        completeCommandExample = 'foxitipanel deleteUser --userName foxitipanel'
        ...
        completeCommandExample = 'foxitipanel suspendUser --userName foxitipanel --state SUSPEND'
        ...
        completeCommandExample = 'foxitipanel editUser --userName foxitipanel --firstName Cyber --lastName Panel --email email@foxitipanel.net --password securepassword --securityLevel HIGH'
    ...
    ### Application installers
        ...
        completeCommandExample = 'foxitipanel installWordPress --domainName foxitipanel.net --email support@foxitipanel.net --userName foxitipanel --password helloworld --siteTitle "WordPress Site" --path helloworld (this is optional)'
        ...
        completeCommandExample = 'foxitipanel installJoomla --domainName foxitipanel.net --password helloworld --siteTitle "WordPress Site" --path helloworld (this is optional)'
        ...
        completeCommandExample = 'foxitipanel switchTOLSWS --licenseKey <Your lsws key here or you can enter TRIAL)'
