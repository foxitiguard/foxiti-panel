...
from FoxitiCP.secMiddleware import secMiddleware
from FoxitiCP.SecurityLevel import SecurityLevel
        ...
        try:
            if request.method == 'POST':
                ...
                if user.twoFA:
                    ...
                    otpauth = pyotp.totp.TOTP(user.secretKey).provisioning_uri(email, issuer_name="foxitiPanel")
