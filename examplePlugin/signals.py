...
# This plugin respond to an event after foxitiPanel core finished deleting a website.
# Original request object is passed, body can be accessed with request.body.

# If any Event handler returns a response object, foxitiPanel will stop further processing and returns your response to browser.
