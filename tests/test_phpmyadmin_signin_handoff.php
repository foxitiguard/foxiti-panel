<?php
/**
 * Regression test for the foxitiPanel-to-phpMyAdmin one-time signon handoff.
 *
...
foreach (array('handoff_token', 'foxitipanel_sessionid', 'curl_exec') as $required) {
...
<?php
$valid = isset($_COOKIE['foxitipanel_sessionid'])
    && $_COOKIE['foxitipanel_sessionid'] === 'authenticatedsession'
