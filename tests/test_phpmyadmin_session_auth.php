...
namespace {
    ...
    $_COOKIE['foxitipanel_sessionid'] = 'originalpanelsessionkey';
    if ($case === 'missing_panel') unset($_COOKIE['foxitipanel_sessionid']);
    if ($case === 'rotated_panel') $_COOKIE['foxitipanel_sessionid'] = 'laterpanelsessionkey';
    ...
    if ($accepted) {
        ...
        if ($mode !== 'baseline') {
            ...
            checkFixture($request['options'][CURLOPT_COOKIE] === 'foxitipanel_sessionid=originalpanelsessionkey', 'originating cookie forwarded');
