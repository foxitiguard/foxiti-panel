...
# .htaccess module, binary integrity, foxitiPanel module
# ============================================================
echo ""
echo "============================================================"
...
# ============================================================
echo "=== TEST GROUP 19: foxitiPanel Module ==="
# ============================================================
if [ -f /usr/local/lsws/modules/foxitipanel_ols.so ]; then
    pass "T19.1: foxitipanel_ols.so module exists"
else
    fail "T19.1: foxitipanel_ols.so module missing"
fi

if grep -q "module foxitipanel_ols" /usr/local/lsws/conf/httpd_config.conf; then
