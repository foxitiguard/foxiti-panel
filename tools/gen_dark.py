#!/usr/bin/env python3
"""Generate a dark-mode override stylesheet for foxitiPanel internal pages.
...
out = []
out.append("/* ====================================================================")
out.append("   foxitiPanel Dark-Mode Overrides  (AUTO-GENERATED — issue #1804)")
out.append("   --------------------------------------------------------------------")
...
dest = os.path.join(ROOT, "baseTemplate/static/baseTemplate/css/foxitipanel-dark.css")
open(dest, "w").write("\n".join(out) + "\n")
