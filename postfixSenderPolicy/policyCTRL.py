...
class policyCTRL:
    applicationPath = '/usr/local/FoxitiCP/postfixSenderPolicy/pid'
    cleaningPID = '/usr/local/FoxitiCP/postfixSenderPolicy/cpid'

    def prepareArguments(self):

        parser = argparse.ArgumentParser(description='foxitiPanel Policy Control Parser!')
    ...
    def start(self):
        ...
        command = '/usr/local/FoxitiCP/postfixSenderPolicy/startServer.py'
