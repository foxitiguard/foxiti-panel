# Contributing to foxitiPanel

Thank you for your interest in contributing to foxitiPanel! This document provides guidelines and information for contributors.

## 🌿 Branch Structure

foxitiPanel uses a structured branching strategy to manage development and releases:
...
1. **Fork the Repository**
   ...
   git clone https://github.com/YOUR_USERNAME/foxitipanel.git
   cd foxitipanel
   ```

2. **Add Upstream Remote**
   ```bash
   git remote add upstream https://github.com/usmannasir/foxitipanel.git
   ```
...
- **OS and Version**: Your operating system and foxitiPanel version
...
- Email security concerns to: security@foxitipanel.net
...
foxitiPanel follows semantic versioning (MAJOR.MINOR.PATCH):
...
- 📚 [Documentation](https://foxitipanel.net/KnowledgeBase/)
- 💬 [Discord](https://discord.gg/g8k8Db3)
- 📢 [Forums](https://community.foxitipanel.net)
- 📵 [Facebook Group](https://www.facebook.com/groups/foxitipanel)
...
By contributing to foxitiPanel, you agree that your contributions will be licensed under the same license as the project (GPL-3.0).

---

**Thank you for contributing to foxitiPanel!** 🎉
