...
app.controller('websitePages', function ($scope, $http, $timeout, $window) {
    ...
    const httpToHTTPS = `### Rewrite Rules Added by foxitiPanel Rewrite Rule Generator

RewriteEngine On
RewriteCond %{HTTPS}  !=on
RewriteRule ^/?(.*) https://%{SERVER_NAME}/$1 [R,L]

### End foxitiPanel Generated Rules.

`;

    const WWWToNonWWW = `### Rewrite Rules Added by foxitiPanel Rewrite Rule Generator
...
`;
    ...
    const nonWWWToWWW = `### Rewrite Rules Added by foxitiPanel Rewrite Rule Generator
...
`;
    ...
    const WordpressProtect = `### Rewrite Rules Added by foxitiPanel Rewrite Rule Generator
...
app.controller('BuyAddons', function ($scope, $http) {
    ...
    $scope.PaypalBuyNowAddons = function (planName, monthlyPrice, yearlyPrice, lifetime, months) {
        ...
        const baseURL = 'https://cp.foxitiguard.com/Billing/AddOnOrderPaypal';
        // Get the current URL
