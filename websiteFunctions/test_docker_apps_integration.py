...
They stand the app up exactly the way foxitiPanel does, on a scratch project name and
a loopback port, then tear it down again. No website, vhost or DockerSites row is touched.

    DOCKER_APPS_INTEGRATION=1 /usr/local/FoxitiCP/bin/python -m unittest \
