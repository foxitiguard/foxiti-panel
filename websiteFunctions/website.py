...
from plogical.FoxitiCPLogFileWriter import FoxitiCPLogFileWriter
...
class WebsiteManager:
    ...
    def SearchOnkeyupPlugin(self, userID=None, data=None):
        try:
            ...
            # logging.FoxitiCPLogFileWriter.writeToFile("Plugin Name ....... %s"%pluginname)
    ...
    def AddNewpluginAjax(self, userID=None, data=None):
        try:
            ...
            # logging.FoxitiCPLogFileWriter.writeToFile(" Name ....... %s"%Name)
    ...
    def deletesPlgin(self, userID=None, data=None, ):
        try:
            ...
            # logging.FoxitiCPLogFileWriter.writeToFile("pluginbID ....... %s" % pluginbBucketID)
            # logging.FoxitiCPLogFileWriter.writeToFile("pluginname ....... %s" % pluginname)
        ...
        try:
            ...
            try:
                ...
                try:
                    ...
                    logging.FoxitiCPLogFileWriter.writeToFile("Creating Bucket Error: %s" % str(msg))
                    data_ret = {'status': 0, 'error_message': str(msg)}
                    json_data = json.dumps(data_ret)
                    return HttpResponse(json_data)
        ...
        try:
            ...
            for web in allweb:
                ...
                if os.path.exists(ProcessUtilities.debugPath):
                    logging.FoxitiCPLogFileWriter.writeToFile(result)
    ...
    def ChangeStatusThemes(self, userID=None, data=None):
        try:
            # logging.FoxitiCPLogFileWriter.writeToFile("Error WP ChangeStatusThemes ....... %s")
            currentACL = ACLManager.loadedACL(userID)
            admin = Administrator.objects.get(pk=userID)
    ...
    def UpdateWPSettings(self, userID=None, data=None):
        ...
        try:
            ...
            if setting == 'search-indexing':
                ...
                if value:
                    tempPath = f'/home/foxitipanel/{str(randint(1000, 9999))}'
...
"""
    ...
    def submitWebsiteCreation(self, userID=None, data=None):
        try:
            ...
            if data['domainName'].find("foxitipanel.website") > -1:
                url = "https://cp.foxitiguard.com/CyberpanelAdOns/CreateDomain"
            ...
            tempStatusPath = "/home/foxitipanel/" + str(randint(1000, 9999))
    ...
    def fetchWebsitesList(self, userID=None, data=None):
        try:
            ...
            if os.path.exists(ProcessUtilities.debugPath):
                logging.FoxitiCPLogFileWriter.writeToFile(f'Fetch sites step 1..')

            endPageNumber, finalPageNumber = self.recordsPointer(pageNumber, recordsToShow)

            if os.path.exists(ProcessUtilities.debugPath):
                logging.FoxitiCPLogFileWriter.writeToFile(f'Fetch sites step 2..')

            websites = ACLManager.findWebsiteObjects(currentACL, userID)

            if os.path.exists(ProcessUtilities.debugPath):
                logging.FoxitiCPLogFileWriter.writeToFile(f'Fetch sites step 3..')

            pagination = self.getPagination(len(websites), recordsToShow)

            if os.path.exists(ProcessUtilities.debugPath):
                logging.FoxitiCPLogFileWriter.writeToFile(f'Fetch sites step 4..')

            json_data = self.findWebsitesListJson(websites[finalPageNumber:endPageNumber])

            if os.path.exists(ProcessUtilities.debugPath):
                logging.FoxitiCPLogFileWriter.writeToFile(f'Fetch sites step 5..')
    ...
    def fetchChildDomainsMain(self, userID=None, data=None):
        try:
            ...
            import traceback
            logging.FoxitiCPLogFileWriter.writeToFile(f"fetchChildDomainsMain error for userID {userID}: {str(msg)}\n{traceback.format_exc()}")
            dic = {'status': 1, 'listWebSiteStatus': 0, 'error_message': str(msg)}
            json_data = json.dumps(dic)
            return HttpResponse(json_data)
    ...
    def findWebsitesListJson(self, websites):
        try:
            ...
            logging.FoxitiCPLogFileWriter.writeToFile("Failed to read machine IP, error:" + str(msg))
    ...
    def submitWebsiteDeletion(self, userID=None, data=None):
        try:
            if data['websiteName'].find("foxitipanel.website") > -1:
                url = "https://cp.foxitiguard.com/CyberpanelAdOns/DeleteDomain"
            ...
            state = wait_for_deletion(execPath, ProcessUtilities.outputExecutioner,
                                      lambda message: logging.FoxitiCPLogFileWriter.writeToFile(
    ...
    def submitWebsiteStatus(self, userID=None, data=None):
        try:
            ...
            if state == "Suspend":
                ...
                suspensionPagePath = "/usr/local/FoxitiCP/websiteFunctions/suspension.html"
    ...
    <div class="container">
        ...
        <p class="contact">For support, please contact your system administrator.</p>
                    ...
                    try:
                        ...
                        # Write the HTML content to a temporary file in /home/foxitipanel
                        tempFile = "/home/foxitipanel/suspension_temp.html"
...
context /{
  ...
  rewrite  {
    ...
    rules                   <<<END_rules
RewriteEngine On
RewriteCond %{REQUEST_URI} !^/foxitipanel_suspension_page\.html$
RewriteRule ^(.*)$ /foxitipanel_suspension_page.html [L]
END_rules
  }
...
context /foxitipanel_suspension_page.html {
  location                        /usr/local/FoxitiCP/websiteFunctions/suspension.html
  accessible                      1
...
"""
                ...
                try:
                    ...
                    if vhostContent and "# Website Suspension Configuration" not in vhostContent:
                        ...
                        import tempfile
                        with tempfile.NamedTemporaryFile(mode='w', delete=False, prefix='foxitipanel_') as tmpfile:
                    ...
                    try:
                        ...
                        try:
                            ...
                            if childVhostContent and "# Website Suspension Configuration" not in childVhostContent:
                                ...
                                import tempfile
                                with tempfile.NamedTemporaryFile(mode='w', delete=False, prefix='foxitipanel_child_') as tmpfile:
                        ...
                        FoxitiCPLogFileWriter.writeToFile(f"Error suspending child domain {items.domain}: {str(e)}")
                ...
                for items in childDomains:
                    ...
                    try:
                        ...
                        FoxitiCPLogFileWriter.writeToFile(f"Error unsuspending child domain {items.domain}: {str(e)}")
            ...
            FoxitiCPLogFileWriter.writeToFile(f"Error in submitWebsiteStatus: {str(msg)}")
    ...
    def saveWebsiteChanges(self, userID=None, data=None):
        try:
            ...
            ## Fix https://github.com/usmannasir/foxitipanel/issues/998

            # from plogical.IncScheduler import IncScheduler
            # isPU = IncScheduler('CalculateAndUpdateDiskUsage', {})
            # isPU.start()

            command = '/usr/local/FoxitiCP/bin/python /usr/local/FoxitiCP/plogical/IncScheduler.py UpdateDiskUsageForce'
    ...
    def loadDomainHome(self, request=None, userID=None, data=None):
        ...
        if Websites.objects.filter(domain=self.domain).exists():
            ...
            try:
                ...
                accessed_via_ip = False
                FoxitiCPLogFileWriter.writeToFile(f"Error detecting accessed_via_ip: {str(e)}")
            ...
            try:
                ...
                FoxitiCPLogFileWriter.writeToFile(
            ...
            try:
                ...
                if 'missing' in check_service:
                    ProcessUtilities.outputExecutioner(f'cp /usr/local/FoxitiCP/fastapi_ssh_server.service {service_path}')
                    ProcessUtilities.outputExecutioner('systemctl daemon-reload')
            except Exception as e:
                FoxitiCPLogFileWriter.writeToFile(f"Failed to copy or reload fastapi_ssh_server.service: {e}")
                ...
                if os.path.exists(csfPath):
                    ...
                    try:
                        ...
                        try:
                            ...
                            FoxitiCPLogFileWriter.writeToFile(str(msg))

            except Exception as e:
                FoxitiCPLogFileWriter.writeToFile(f"Failed to ensure fastapi_ssh_server is running: {e}")
            ...
            try:
                ...
                FoxitiCPLogFileWriter.writeToFile(f"Could not fetch resource limits for {self.domain}: {str(e)}")
    ...
    def getDataFromLogFile(self, userID=None, data=None):
        ...
        if output.find("1,None") > -1:
            final_json = json.dumps(
                {'status': 0, 'logstatus': 0,
                 'error_message': "Not able to fetch logs, see foxitiPanel main log file, Error: %s" % (output)})
            return HttpResponse(final_json)
    ...
    def fetchErrorLogs(self, userID=None, data=None):
        ...
        if output.find("1,None") > -1:
            final_json = json.dumps(
                {'status': 0, 'logstatus': 0, 'error_message': "Not able to fetch logs, see foxitiPanel main log file!"})
            return HttpResponse(final_json)
    ...
    def saveConfigsToFile(self, userID=None, data=None):
        ...
        if ProcessUtilities.outputExecutioner(command).find('127.0.0.1') == -1:
            ...
            tempPath = "/home/foxitipanel/" + str(randint(1000, 9999))
    ...
    def saveSSL(self, userID=None, data=None):
        ...
        tempKeyPath = "/home/foxitipanel/" + str(randint(1000, 9999))
        vhost = open(tempKeyPath, "w")
        vhost.write(key)
        vhost.close()

        tempCertPath = "/home/foxitipanel/" + str(randint(1000, 9999))
        ...
        try:
            ...
            for alias in website.childdomains_set.filter(alais=1):
                ...
                try:
                    ...
                    logging.FoxitiCPLogFileWriter.writeToFile(f'Error changing PHP for alias: {str(msg)}')
    ...
    def getWebsiteCron(self, userID=None, data=None):
        try:
            ...
            execPath = "/usr/local/FoxitiCP/bin/python " + virtualHostUtilities.cyberPanel + "/plogical/cronUtil.py"
    ...
    def webhookSecretPath(domain):
        return '/home/foxitipanel/git/%s.webhook_secret' % (domain)
    ...
    def getOrCreateWebhookSecret(domain):
        ...
        try:
            ...
            gitConfFolder = '/home/foxitipanel/git'
    ...
    def setupGit(self, request=None, userID=None, data=None):
        ...
        path = '/home/foxitipanel/' + self.domain + '.git'
...
""" % (self.domain, website.externalApp)
    ...
    def searchWebsitesJson(self, currentlACL, userID, searchTerm):
        ...
        for items in websites:
            ...
            if os.path.exists(ProcessUtilities.debugPath):
                logging.FoxitiCPLogFileWriter.writeToFile(vhFile)
    ...
    def tuneSettings(self, userID=None, data=None):
        try:
            ...
            if os.path.exists(ProcessUtilities.debugPath):
                logging.FoxitiCPLogFileWriter.writeToFile(f'PHP path in tune settings {phpPath}')
            ...
            if os.path.exists(ProcessUtilities.debugPath):
                logging.FoxitiCPLogFileWriter.writeToFile(f'PHP Version in tune settings {phpVersion}')

            phpService = ApacheVhost.DecideFPMServiceName(phpVersion)

            if os.path.exists(ProcessUtilities.debugPath):
                logging.FoxitiCPLogFileWriter.writeToFile(f'PHP service in tune settings {phpService}')
    ...
    def sshAccess(self, request=None, userID=None, data=None):
        ...
        #FoxitiCPLogFileWriter.writeToFile(f"has_addons: {has_addons}")
        ...
        try:
            ...
            FoxitiCPLogFileWriter.writeToFile(f"ssl_provider: {ssl_provider}")
            ...
            is_selfsigned = True  # If cert missing or unreadable, treat as self-signed
            FoxitiCPLogFileWriter.writeToFile(f"is_selfsigned: {is_selfsigned}. Error: {str(e)}")
    ...
    def saveSSHAccessChanges(self, userID=None, data=None):
        try:
            ...
            pythonPath = '/usr/local/FoxitiCP/bin/python'
    ...
    def folderCheck(self):
        ...
        try:
            ...
            logging.FoxitiCPLogFileWriter.writeToFile('%s. [folderCheck:3002]' % (str(msg)))
    ...
    def deleteSSHKey(self, userID=None, data=None):
        try:
            ...
            execPath = "/usr/local/FoxitiCP/bin/python " + virtualHostUtilities.cyberPanel + "/plogical/firewallUtilities.py"
    ...
    def addSSHKey(self, userID=None, data=None):
        try:
            ...
            execPath = "sudo /usr/local/FoxitiCP/bin/python " + virtualHostUtilities.cyberPanel + "/plogical/firewallUtilities.py"
    ...
    def fetchDockersite(self, userID=None, data=None):
        try:
            ...
            logging.FoxitiCPLogFileWriter.writeToFile("Our dockersite" + str(dockersites))
        ...
        try:
            ...
            for backup in backups:
                try:
                    ...
                    logging.FoxitiCPLogFileWriter.writeToFile(f"Error parsing backup config: {str(e)}")
                    continue
