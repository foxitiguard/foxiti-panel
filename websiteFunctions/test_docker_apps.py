...
Run standalone (no database needed):
    /usr/local/FoxitiCP/bin/python -m unittest websiteFunctions.test_docker_apps -v
"""
...
def make_site(app='Hermes'):
    ...
    site.data = {
        'JobID': '/home/foxitipanel/test-job',
...
class TestHermesCompose(unittest.TestCase):
    ...
    def test_auth_gate_is_satisfied(self):
        ...
        self.assertEqual(self.environment['HERMES_DASHBOARD_BASIC_AUTH_USERNAME'], 'foxitipanel')
