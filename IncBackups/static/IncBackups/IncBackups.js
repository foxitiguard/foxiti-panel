...
app.controller('createIncrementalBackups', function ($scope, $http, $timeout) {
    ...
    function getBackupStatus() {
        ...
        $scope.foxitipanelLoadingBottom = false;
        ...
        function ListInitialDatas(response) {
            ...
            if (response.data.backupStatus === 1) {
                ...
                if (response.data.abort === 1) {
                    $timeout.cancel();
                    $scope.foxitipanelLoadingBottom = true;
                    $scope.destination = false;
...
app.controller('ConfigureV2Backup', function ($scope, $http, $timeout) {
    ...
    $scope.setupAccount = function () {
        window.open("https://cp.foxitiguard.com/gDrive?name=" + $scope.accountName + '&client_id=' + $scope.client_id + '&client_secret=' + $scope.client_secret + '&server=' + window.location.href + 'Setup&domain=' + $scope.selwebsite);
    };
