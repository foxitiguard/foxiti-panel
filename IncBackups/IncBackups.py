...
class IncJobs(multi.Thread):
    ...
    def prepareBackupMeta(self):
        try:
            ...
            metaPath = '/home/foxitipanel/%s' % (str(randint(1000, 9999)))
    ...
    def backupDatabases(self):
        try:
            ...
            for items in databases:
                if mysqlUtilities.mysqlUtilities.createDatabaseBackup(items.dbName, '/home/foxitipanel') == 0:
                    return 0

                dbPath = '/home/foxitipanel/%s.sql' % (items.dbName)
