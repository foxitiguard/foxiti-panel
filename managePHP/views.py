    ...
    try:
        ...
        if PHP.objects.count() == 0:
            ...
            if ProcessUtilities.decideDistro() == ProcessUtilities.centos or ProcessUtilities.decideDistro() == ProcessUtilities.cent8:
                phpPath = os.path.join('/usr', 'local', 'FoxitiCP', 'managePHP', 'php70.xml')
            else:
                phpPath = os.path.join('/usr', 'local', 'FoxitiCP', 'managePHP', 'ubuntuphp70.xml')
            ...
            if ProcessUtilities.decideDistro() == ProcessUtilities.centos or ProcessUtilities.decideDistro() == ProcessUtilities.cent8:
                phpPath = os.path.join('/usr', 'local', 'FoxitiCP', 'managePHP', 'php71.xml')
            else:
                phpPath = os.path.join('/usr', 'local', 'FoxitiCP', 'managePHP', 'ubuntuphp71.xml')
        ...
        if PHP.objects.count() == 6:
            ...
            if ProcessUtilities.decideDistro() == ProcessUtilities.centos or ProcessUtilities.decideDistro() == ProcessUtilities.cent8:
                php72Path = os.path.join('/usr', 'local', 'FoxitiCP', 'managePHP', 'php72.xml')
            else:
                php72Path = os.path.join('/usr', 'local', 'FoxitiCP', 'managePHP', 'ubuntuphp72.xml')
        ...
        if PHP.objects.count() == 7:
            ...
            if ProcessUtilities.decideDistro() == ProcessUtilities.centos or ProcessUtilities.decideDistro() == ProcessUtilities.cent8:
                php73Path = os.path.join('/usr', 'local', 'FoxitiCP', 'managePHP', 'php73.xml')
            else:
                php73Path = os.path.join('/usr', 'local', 'FoxitiCP', 'managePHP', 'ubuntuphp73.xml')
        ...
        if PHP.objects.count() == 8:
            ...
            if ProcessUtilities.decideDistro() == ProcessUtilities.centos or ProcessUtilities.decideDistro() == ProcessUtilities.cent8:
                php74Path = os.path.join('/usr', 'local', 'FoxitiCP', 'managePHP', 'php74.xml')
            else:
                php74Path = os.path.join('/usr', 'local', 'FoxitiCP', 'managePHP', 'ubuntuphp74.xml')
        ...
        try:
            ...
            if ProcessUtilities.decideDistro() == ProcessUtilities.centos or ProcessUtilities.decideDistro() == ProcessUtilities.cent8:
                php80Path = os.path.join('/usr', 'local', 'FoxitiCP', 'managePHP', 'php80.xml')
            else:
                php80Path = os.path.join('/usr', 'local', 'FoxitiCP', 'managePHP', 'ubuntuphp80.xml')
        ...
        try:
            ...
            if ProcessUtilities.decideDistro() == ProcessUtilities.centos or ProcessUtilities.decideDistro() == ProcessUtilities.cent8:
                php81Path = os.path.join('/usr', 'local', 'FoxitiCP', 'managePHP', 'php81.xml')
            else:
                php81Path = os.path.join('/usr', 'local', 'FoxitiCP', 'managePHP', 'ubuntuphp81.xml')
    ...
    try:
        ...
        try:
            if request.method == 'POST':
                ...
                if type == "install":
                    execPath = "/usr/local/FoxitiCP/bin/python " + virtualHostUtilities.cyberPanel + "/plogical/phpUtilities.py"
...
def savePHPConfigAdvance(request):
    try:
        ...
        logging.FoxitiCPLogFileWriter.writeToFile(str(msg) + "[saveConfigsToFile]")
