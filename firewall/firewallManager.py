...
class FirewallManager:
        ...
        try:
            ...
            if res == 1:
                ...
                final_dic = {'reload_status': 0,
                             'error_message': "Can not reload firewall, see FoxitiCP main log file."}
                final_json = json.dumps(final_dic)
                return HttpResponse(final_json)
        ...
        try:
            ...
            if res == 1:
                ...
                final_dic = {'start_status': 0,
                             'error_message': "Can not start firewall, see FoxitiCP main log file."}
                final_json = json.dumps(final_dic)
                return HttpResponse(final_json)
        ...
        try:
            ...
            if res == 1:
                ...
                final_dic = {'stop_status': 0,
                             'error_message': "Can not stop firewall, see FoxitiCP main log file."}
                final_json = json.dumps(final_dic)
                return HttpResponse(final_json)
    ...
    def installModSec(self, userID = None, data = None):
        try:
            ...
            execPath = "/usr/local/FoxitiCP/bin/python " + virtualHostUtilities.cyberPanel + "/plogical/modSec.py"
    ...
    def saveLitespeed_conf(self, userID = None, data = None):
        try:
            ...
            tempRulesPath = '/home/foxitipanel/pre_main_global.conf'
