...
class ApacheController:
    apacheInstallStatusPath = '/home/foxitipanel/apacheInstallStatus'
...
<IfModule mpm_event_module>
    ...
    def setupApache(statusFile):
        try:
            ...
            logging.FoxitiCPLogFileWriter.statusWriter(statusFile, 'Starting Apache installation. It may take some time..,70')
            ...
            logging.FoxitiCPLogFileWriter.statusWriter(statusFile,
