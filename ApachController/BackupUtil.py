...
class BackupUtil:
    ...
    def SendEmail(message):
        sender = 'support@foxitiguard.com'
        receivers = ['support@foxitiguard.com', 'support@foxitiguard.com']
    ...
    @staticmethod
    def BackupDBS():
        command = "/usr/local/FoxitiCP/ApachController/backup.sh"
        BackupUtil.normalExecutioner(command)
...
def main():
    ...
    parser = argparse.ArgumentParser(description='foxitiPanel Backup tool.')
