...
FP_TEST_MYSQL_HOST=127.0.0.1 \\
FP_TEST_MYSQL_PORT=33306 \\
FP_TEST_MYSQL_ROOT_USER=root \\
FP_TEST_MYSQL_ROOT_PASSWORD='...' \\
...
class RemoteMySQLInstallationTests(unittest.TestCase):
    ...
    def test_django_settings_resolve_to_the_remote_endpoint(self):
        """Load the generated file the way FoxitiCP/settings.py does and check
        ...
        default = {
            'NAME': env.get('DB_NAME', 'foxitipanel'),
            'USER': env.get('DB_USER', 'foxitipanel'),
