...
class TestFTP(TestCase):
    ...
    def test_submitFTPCreation(self):
        ...
        data_ret = {'ftpDomain': 'foxitipanel.xyz', 'ftpUserName':'hello', 'passwordByPass':'helloworld'}
        ...
        try:
            ok = 1
            ftp = ftplib.FTP('foxitipanel.xyz')
        ...
        self.assertEqual(os.path.exists('/home/foxitipanel.xyz/unittest'), True)
