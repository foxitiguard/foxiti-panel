...
def router(request):
    try:
        ...
        if controller == 'verifyLogin':
        ...
        elif controller == 'SubmitfoxitiPanelUpgrade':
            return cm.SubmitfoxitiPanelUpgrade()
            ...
            return cm.ajaxPre(0, 'This function is not available in your version of foxitiPanel.')
