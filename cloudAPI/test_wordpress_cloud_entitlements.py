...
def load_cloud():
    ...
    allowed_imports = {
        'os': safe_os,
        'plogical.FoxitiCPLogFileWriter': SimpleNamespace(FoxitiCPLogFileWriter=services['logging']),
    ...
    namespace = {
        **services, '__builtins__': {**vars(builtins), '__import__': inert_import},
        ...
        'virtualHostUtilities': SimpleNamespace(cyberPanel='/inert/FoxitiCP'),
...
class CloudWordPressEntitlementTests(unittest.TestCase):
    ...
    def test_paid_deployment_keeps_worker_and_status_response(self):
        ...
        self.assertEqual(result['tempStatusPath'], '/home/foxitipanel/1000')
