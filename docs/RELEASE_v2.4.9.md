# foxitiPanel v2.4.9 (build 9) — Release Notes
...
**foxitiPanel v2.4.9 (build 9) is out — a security & reliability maintenance release.**
...
**⚙️ Stack**
- Updated foxitiPanel-OLS stack (core 2.5.1 / module 2.7.5 / mod_security 2.5.1),
