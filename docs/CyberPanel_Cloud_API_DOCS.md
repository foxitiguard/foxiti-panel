# foxitiPanel Cloud Platform - VPS API Documentation

**Version:** 1.0.0
**Base URL:** `https://cp.foxitiguard.com/api/v1`
...
The foxitiPanel Cloud Platform API allows you to programmatically manage your VPS instances, view account information, and automate your infrastructure. This RESTful API uses JSON for request and response bodies.

### Quick Start

1. Create an API key at https://cp.foxitiguard.com/api-keys/
...
```json
{
  ...
  "data": {
    "templates": [
      {"id": "101", "name": "foxitiPanel", "os": "AlmaLinux 8", "description": "foxitiPanel pre-installed with OpenLiteSpeed"},
...
BASE_URL = "https://cp.foxitiguard.com/api/v1"
...
const BASE_URL = "https://cp.foxitiguard.com/api/v1";
...
```bash
# Test authentication
curl -X GET "https://cp.foxitiguard.com/api/v1/test" \
  -H "Authorization: Bearer cyp_live_your_api_key_here"

# List VPS instances
curl -X GET "https://cp.foxitiguard.com/api/v1/vps" \
  -H "Authorization: Bearer cyp_live_your_api_key_here"

# Create VPS
curl -X POST "https://cp.foxitiguard.com/api/v1/vps/create" \
  -H "Authorization: Bearer cyp_live_your_api_key_here" \
...
# Stop VPS
curl -X POST "https://cp.foxitiguard.com/api/v1/vps/45/stop" \
  -H "Authorization: Bearer cyp_live_your_api_key_here"

# Delete VPS (WARNING: Permanent!)
curl -X POST "https://cp.foxitiguard.com/api/v1/vps/45/delete" \
  -H "Authorization: Bearer cyp_live_your_api_key_here"
```
...
- **Documentation:** https://cp.foxitiguard.com/api-keys/
- **Support Tickets:** https://cp.foxitiguard.com/support/
- **Email:** help@foxitipanel.net
