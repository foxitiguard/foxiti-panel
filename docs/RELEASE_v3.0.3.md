# foxitiPanel v3.0.3 (build 3) — Release Notes

_Released 2026-08-20._

foxitiPanel v3.0.3 is a security hotfix for API authentication and account
...
2. Update `https://foxitipanel.net/version.txt` to exactly
   `{"version":"3.0","build":3}` with no trailing newline.
3. Publish the `v3.0.3` changelog entry on the foxitiPanel changelog page.
