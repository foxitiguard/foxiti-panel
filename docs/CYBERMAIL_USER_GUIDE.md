...
**For**: foxitiPanel users and resellers
...
CyberMail is foxitiPanel's built-in email delivery service. It routes your outgoing emails through optimized servers so they land in the inbox instead of spam. Every foxitiPanel installation includes CyberMail with a free tier of 15,000 emails per month.
...
Log into foxitiPanel and navigate to: **Email > Email Delivery** or go directly to `https://your-server:8090/emailDelivery/`
...
CyberMail will automatically set up the DNS records needed for email delivery (SPF, DKIM, DMARC). If your domain's DNS is managed by foxitiPanel's PowerDNS, this happens instantly.
...
To upgrade, visit the CyberMail platform at https://cp.foxitiguard.com
...
**Q: My domain DNS is not managed by foxitiPanel. Can I still use CyberMail?**
...
- **foxitiPanel Issues**: https://github.com/usmannasir/foxitipanel/issues
- **CyberMail Platform**: https://cp.foxitiguard.com
