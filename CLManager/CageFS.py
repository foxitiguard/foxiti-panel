...
class CageFS:
    ...
    def submitinstallImunify(key):
        try:
            ...
            imunifyKeyPath = '/home/foxitipanel/imunifyKeyPath'
            ...
            with open(ServerStatusUtil.lswsInstallStatusPath, 'w') as statusFile:
                logging.FoxitiCPLogFileWriter.statusWriter(
...
def main():
    ...
    parser = argparse.ArgumentParser(description='foxitiPanel CageFS Manager')
