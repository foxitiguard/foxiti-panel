...
def test_firewall_blocking():
    ...
    # Test configuration
    base_url = "https://localhost:8090"  # Adjust based on your foxitiPanel setup
    ...
    print("1. Valid foxitiPanel session with admin privileges")
    print("2. foxitiPanel addons enabled")
    print("3. Active firewalld service")
    print()
    
    print("To test manually:")
    print("1. Login to foxitiPanel dashboard")
