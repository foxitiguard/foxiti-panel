...
def fetchWebsiteLimits(request):
    try:
        ...
        try:
            ...
            confPathTemp = "/home/foxitipanel/" + str(randint(1000, 9999))
            ...
            if finalContent == 0:
                return httpProc.AJAX(0, 'Please check foxitiPanel main log file.')
    ...
    try:
        ...
        if enforce == True:
            if websiteLimits.enforce == 0:
                ...
                cgrulesTemp = "/home/foxitipanel/" + str(randint(1000, 9999))
        ...
        try:
            ...
            try:
                if type == 'memory':
                    ...
                    path = '/home/foxitipanel/' + website.externalApp
