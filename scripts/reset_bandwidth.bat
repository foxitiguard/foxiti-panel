@echo off
REM foxitiPanel Bandwidth Reset Script for Windows
REM This script resets bandwidth usage for all domains in foxitiPanel
...
REM Check if foxitiPanel is installed
if not exist "C:\Program Files\foxitiPanel\bin\python.exe" (
...
"C:\Program Files\foxitiPanel\bin\python.exe" "C:\Program Files\foxitiPanel\plogical\bandwidthReset.py" --reset-all
...
if %errorLevel% == 0 (
    ...
    echo 1. Check the foxitiPanel logs
