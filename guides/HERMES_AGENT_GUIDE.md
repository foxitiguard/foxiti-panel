...
foxitiPanel can deploy [Hermes Agent](https://hermes-agent.nousresearch.com) as a
one-click Docker application, on its own domain, behind your own SSL, with a
password-protected dashboard.

Available from foxitiPanel **v3.0.2**.
...
- **Model provider:** you need an API key for whichever provider you plan to use
  ...
  **inside the Hermes dashboard after the deployment**, foxitiPanel never asks for
