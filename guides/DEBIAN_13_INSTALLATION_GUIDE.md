# Debian 13 Installation Guide for foxitiPanel

## 🎯 Overview

This guide provides step-by-step instructions for installing foxitiPanel on Debian 13 (Bookworm). Debian 13 support has been added to foxitiPanel with full compatibility for package management, service configuration, and web server setup.
...
### Step 2: Download and Run foxitiPanel Installer

```bash
# Download the latest foxitiPanel installer
wget https://foxitipanel.sh/install.sh
...
```bash
# Check foxitiPanel service status
sudo systemctl status lscpd

# Check web server status
sudo systemctl status apache2

# Check if foxitiPanel is accessible
...
```bash
# Login to foxitiPanel CLI
sudo foxitipanel

# Change admin password
foxitipanel --change-password admin
```

### Configure Firewall

```bash
# Allow foxitiPanel ports
...
**Problem**: foxitiPanel service fails to start
...
- **foxitiPanel**: `/usr/local/FoxitiCP/logs/`
- **Apache2**: `/var/log/apache2/`
- **System**: `/var/log/syslog`
- **Installation**: `/root/foxitipanel-install.log`
...
1. **Change Default Password**
   ```bash
   sudo foxitipanel --change-password admin
   ```
...
1. **Access foxitiPanel Web Interface**
...
sudo foxitipanel --update

# Or use the upgrade script
sudo ./foxitipanel_upgrade.sh
```
...
### Documentation
- [foxitiPanel Official Docs](https://foxitipanel.net/docs/)
...
### Community Support
- [foxitiPanel Community Forum](https://forums.foxitipanel.net/)
- [GitHub Issues](https://github.com/usmannasir/foxitipanel/issues)
- [Discord Server](https://discord.gg/foxitipanel)
...
wget https://raw.githubusercontent.com/foxitipanel/foxitipanel/main/test_debian13_support.sh
...
- [ ] foxitiPanel web interface accessible
...
**Note**: This guide is specifically for Debian 13. For other operating systems, refer to the main foxitiPanel documentation.
