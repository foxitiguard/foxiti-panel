# foxitiPanel 2.5.5-dev Custom CSS Guide

A comprehensive guide for creating custom CSS that fully works with the new design system of foxitiPanel 2.5.5-dev.
...
foxitiPanel 2.5.5-dev features a modern, CSS-variable-based design system that supports both light and dark themes. The system is built with:
...
```css
/* Custom foxitiPanel Theme - Ocean Blue */
...
This guide provides everything you need to create beautiful, functional custom CSS for foxitiPanel 2.5.5+. Remember to always test your changes thoroughly and use the CSS variables for consistency across themes.
