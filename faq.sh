...
${PURPLE}1.${NC} How to reset foxitiPanel admin password?
...
Please check this post: ${GREEN}https://community.foxitipanel.net/c/support/55${NC}

${BLUE}------------------------------------------------------------${NC}

${PURPLE}4.${NC} What is MariaDB root password ?

execute command ${RED}cat /etc/foxitipanel/mysqlPassword${NC} will show you the root password
...
${RED}/etc/foxitipanel/mysqlPassword${NC}

${RED}/usr/local/FoxitiCP/FoxitiCP/settings.py${NC}

otherwise foxitiPanel will not have access to database.

${BLUE}------------------------------------------------------------${NC}

${PURPLE}6.${NC} How to raise upload limit for foxitipanel's phpMyAdmin and File Manager?
...
For OpenLiteSpeed, please check this post: ${GREEN}https://community.foxitipanel.net/c/support/55${NC}

For LiteSpeed Enterprise, please check this post: ${GREEN}https://community.foxitipanel.net/c/support/55${NC}

${BLUE}------------------------------------------------------------${NC}

${PURPLE}8.${NC} How to remove 8090 port in foxitiPanel URL ?

Please check this post ${GREEN}https://blog.foxitipanel.net/2018/12/25/how-to-remove-port-8090-from-foxitipanel/${NC}
