...
---
**Important**
Do not create a new issue if there is already an issue similar(even if nearly) to yours already posted by someone. Just post an update of your issue in that old issue. At this moment foxitiPanel only have few contributors. Please do not create any maintenance burden.
