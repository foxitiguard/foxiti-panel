...
class installUtilities:
    ...
    def enableEPELRepo():
        try:
            ...
            logging.FoxitiCPLogFileWriter.writeToFile(str(msg) + " [enableEPELRepo]")
            return 0
    ...
    def addLiteSpeedRepo():
        try:
            ...
            logging.FoxitiCPLogFileWriter.writeToFile(str(msg) + " [addLiteSpeedRepo]")
            return 0
        except ValueError as msg:
            logging.FoxitiCPLogFileWriter.writeToFile(str(msg) + " [addLiteSpeedRepo]")
            return 0
    ...
    def installLiteSpeed():
        ...
        try:
            ...
            logging.FoxitiCPLogFileWriter.writeToFile(str(msg) + " [installLiteSpeed]")
            return 0
        except ValueError as msg:
            logging.FoxitiCPLogFileWriter.writeToFile(str(msg) + " [installLiteSpeed]")
            return 0
    ...
    def startLiteSpeed():
        ...
        try:
            ...
            logging.FoxitiCPLogFileWriter.writeToFile(str(msg) + " [startLiteSpeed]")
            return 0
        except ValueError as msg:
            logging.FoxitiCPLogFileWriter.writeToFile(str(msg) + " [startLiteSpeed]")
            return 0
    ...
    def reStartLiteSpeed():
        try:
            ...
            logging.FoxitiCPLogFileWriter.writeToFile(str(msg) + " [reStartLiteSpeed]")
            return 0
    ...
    def reStartOpenLiteSpeed(restart,orestart):
        try:
            ...
            logging.FoxitiCPLogFileWriter.writeToFile(str(msg) + " [reStartOpenLiteSpeed]")
            return 0
        except ValueError as msg:
            logging.FoxitiCPLogFileWriter.writeToFile(str(msg) + " [reStartOpenLiteSpeed]")
            return 0
    ...
    def changePortTo80():
        try:
            ...
            logging.FoxitiCPLogFileWriter.writeToFile(str(msg) + " [changePortTo80]")
            return 0
    ...
    def installAllPHPVersion():
        ...
        try:
            ...
            logging.FoxitiCPLogFileWriter.writeToFile(str(msg) + " [installAllPHPVersion]")
    ...
    def installAllPHPToLitespeed():
        try:
            ...
            logging.FoxitiCPLogFileWriter.writeToFile(str(msg) + " [installAllPHPToLitespeed]")
            return 0
    ...
    def removeWebServer():
        ...
        try:
            ...
            logging.FoxitiCPLogFileWriter.writeToFile(str(msg) + " [removeWebServer]")
            return 0
        except ValueError as msg:
            logging.FoxitiCPLogFileWriter.writeToFile(str(msg) + " [removeWebServer]")
            return 0
    ...
    def startMariaDB():
        ...
        try:
            ...
            logging.FoxitiCPLogFileWriter.writeToFile(str(msg) + " [startMariaDB]")
            return 0
        except ValueError as msg:
            logging.FoxitiCPLogFileWriter.writeToFile(str(msg) + " [startMariaDB]")
            return 0
    ...
    def installMySQL(password):
        ...
        try:
            ...
            logging.FoxitiCPLogFileWriter.writeToFile(str(msg) + " [installMySQL]")
        ...
        try:
            ...
            logging.FoxitiCPLogFileWriter.writeToFile(str(msg) + " Could not add mariadb to startup [installMySQL]")
            return 0
        except ValueError as msg:
            logging.FoxitiCPLogFileWriter.writeToFile(str(msg) + " Could not add mariadb to startup [installMySQL]")
            return 0
    ...
    def secureMysqlInstallation(password):
        ...
        try:
            ...
            logging.FoxitiCPLogFileWriter.writeToFile(str(msg) + " Exception EOF [installMySQL]")
            print("###########################Before########################################")
