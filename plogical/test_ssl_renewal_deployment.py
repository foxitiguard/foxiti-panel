...
class RenewalDeploymentTests(unittest.TestCase):
    def setUp(self):
        ...
        log = mock.patch.object(ssl_module.logging.FoxitiCPLogFileWriter,
                                'writeToFile')
        self.log = log.start()
