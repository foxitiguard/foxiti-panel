...
class EntitlementTests(unittest.TestCase):
    def setUp(self):
        ...
        FPBackupsV2=Mock(side_effect=forbidden),
    ...
    def test_root_file_pages_and_download_deny_before_any_work(self):
        ...
        self.assertEqual({'redirect': 'https://foxitipanel.net/foxitipanel-addons'}, self.env['FileManagerRoot'](object()))
    ...
    def test_mysql_pages_and_actions_deny_before_work(self):
        ...
        for name in pages:
            with self.subTest(page=name):
                self.assertEqual({'redirect': 'https://foxitipanel.net/foxitipanel-addons'}, self.env[name](object()))
        for name in actions:
