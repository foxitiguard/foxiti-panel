...
class UpgradeRuntimeRepairTests(unittest.TestCase):
    ...
    @patch('plogical.upgrade.tempfile.mkdtemp', return_value='/tmp/foxitipanel-backup')
    def test_upgrade_backs_up_environment_and_secret_files(
        ...
        self.assertEqual('/tmp/foxitipanel-backup', backup_dir)
        self.assertEqual(protected_files, set(backed_up_files))
        self.assertEqual(
            [
                call('/usr/local/FoxitiCP/.env', '/tmp/foxitipanel-backup/.env'),
                call('/usr/local/FoxitiCP/.env.backup', '/tmp/foxitipanel-backup/.env.backup'),
                call('/usr/local/FoxitiCP/secret_key', '/tmp/foxitipanel-backup/secret_key'),
            ],
