# -*- coding: utf-8 -*-
"""Build and maintain foxitiPanel's Imunify generic-panel integration."""
...
IMUNIFY_AV_UI = '/usr/local/FoxitiCP/public/imunifyav'
IMUNIFY_360_UI = '/usr/local/FoxitiCP/public/imunify'
CLSCRIPT_DIR = '/usr/local/FoxitiCP/CLScript'
DEPLOY_TMP = '/tmp/foxitipanel-imunify-deploy'
INSTALL_STATUS_PATH = '/home/foxitipanel/switchLSWSStatus'
PANEL_PYTHON = '/usr/local/FoxitiCP/bin/python'
CAGEFS_MANAGER = '/usr/local/FoxitiCP/CLManager/CageFS.py'
