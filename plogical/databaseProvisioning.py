...
JOURNAL_DIRECTORY = '/home/foxitipanel/.database-provisioning'
...
class ProvisioningJournal:
    def __init__(self, database, username, website, directory=JOURNAL_DIRECTORY, owner_user='foxitipanel'):
...
def create_and_register(database, username, password, website, utilities, database_model,
                        directory=JOURNAL_DIRECTORY, owner_user='foxitipanel'):
