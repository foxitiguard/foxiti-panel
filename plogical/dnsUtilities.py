...
class DNS:
    ...
    CFPath = '/home/foxitipanel/CloudFlare'
    ...
    def loadCFKeys(self):
        ...
        if os.path.exists(cfFile):
            ...
            #logging.FoxitiCPLogFileWriter.writeToFile('User %s does not have CloudFlare configured.' % (self.admin.userName))
            return 0
    ...
    def createDNSRecordCloudFlare(cf, zone, name, type, value, priority, ttl):
        try:
            ...
            logging.FoxitiCPLogFileWriter.writeToFile(str(msg) + '. [createDNSRecordCloudFlare]')
    ...
    def createDNSRecord(zone, name, type, value, priority, ttl):
        try:
            ...
            logging.FoxitiCPLogFileWriter.writeToFile(str(msg) + " [createDNSRecord]")
...
"""
            ...
            logging.FoxitiCPLogFileWriter.writeToFile(f'ConfigurePowerDNSInAcme, Error: {str(msg)}')
            return 0, str(msg)
...
"""
            ...
            logging.FoxitiCPLogFileWriter.writeToFile(f'ConfigureCloudflareInAcme, Error: {str(msg)}')
            return 0, str(msg)
