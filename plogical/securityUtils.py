...
TERMINAL_JWT_SECRET_ENV = "FOXITIPANEL_TERMINAL_JWT_SECRET"
TERMINAL_JWT_SECRET_FILE_ENV = "FOXITIPANEL_TERMINAL_JWT_SECRET_FILE"
DEFAULT_TERMINAL_JWT_SECRET_FILE = "/usr/local/FoxitiCP/terminal_jwt_secret"
TERMINAL_JWT_ISSUER = "foxitipanel-web-terminal"
TERMINAL_JWT_AUDIENCE = "foxitipanel-fastapi-ssh"
...
EMAIL_REPORT_DIRECTORY = "/home/foxitipanel/.email-reports"
BACKUP_REQUEST_DIRECTORY = "/home/foxitipanel/.backup-requests"
FILE_DOWNLOAD_DIRECTORY = "/usr/local/lscp/foxitipanel/.file-downloads"
SYSTEM_PASSWORD_REQUEST_DIRECTORY = "/tmp/foxitipanel-system-password-requests"
TERMINAL_REQUEST_DIRECTORY = "/home/foxitipanel/.terminal-requests"
...
def _api_two_factor_code(request, data=None):
    code = request.META.get('HTTP_X_FOXITIPANEL_OTP', '')
...
def get_mysql_upgrade_status_path(status_file, base_path="/home/foxitipanel"):
