...
class mailUtilities:
    ...
    installLogPath = "/home/foxitipanel/openDKIMInstallLog"
    spamassassinInstallLogPath = "/home/foxitipanel/spamassassinInstallLogPath"
    RspamdInstallLogPath = "/home/foxitipanel/RspamdInstallLogPath"
    RspamdUnInstallLogPath = "/home/foxitipanel/RspamdUnInstallLogPath"
    cyberPanelHome = "/home/foxitipanel"
    mailScannerInstallLogPath = "/home/foxitipanel/mailScannerInstallLogPath"
    ...
    def setupDKIM(virtualHostName):
        try:
            ...
            if not os.path.exists(keyTable):
                ...
                writeToFile.write("##### foxitiPanel Generated File - Do not edit if you don't know what you are doing.\n")
                writeToFile.close()
...
"""
                ...
                if not os.path.exists(postfixFilePath):
                    logging.FoxitiCPLogFileWriter.writeToFile(f"configureOpenDKIM: {postfixFilePath} not found, skipping postfix DKIM configuration")
...
"""
                ...
                logging.FoxitiCPLogFileWriter.writeToFile(str(msg) + " [configureOpenDKIM]")
                print("0," + str(msg))
                return
            except BaseException as msg:
                logging.FoxitiCPLogFileWriter.writeToFile(str(msg) + " [configureOpenDKIM]")
        ...
        try:
            try:
                ...
                if getpass.getuser() == 'root':
                    ...
                    command = "sudo chown -R foxitipanel:foxitipanel " + mailUtilities.cyberPanelHome
                    subprocess.call(shlex.split(command), stdout=FNULL)
                else:
                    if not os.path.exists(mailUtilities.cyberPanelHome):
                        command = "mkdir " + mailUtilities.cyberPanelHome
                    ...
                    command = "chown -R foxitipanel:foxitipanel " + mailUtilities.cyberPanelHome
                    ProcessUtilities.executioner(command)
            except:
                FNULL = open(os.devnull, 'w')
                command = "chown -R foxitipanel:foxitipanel " + mailUtilities.cyberPanelHome
            ...
            logging.FoxitiCPLogFileWriter.writeToFile(str(msg) + " [checkHome]")
    ...
    def installOpenDKIM(install, openDKIMINstall):
        try:
            ...
            if res == 1:
                ...
                writeToFile.close()
                logging.FoxitiCPLogFileWriter.writeToFile("[Could not Install OpenDKIM.]")
                return 0
            else:
                writeToFile = open(mailUtilities.installLogPath, 'a')
            ...
            writeToFile.writelines("Can not be installed.[404]\n")
            writeToFile.close()
            logging.FoxitiCPLogFileWriter.writeToFile(str(msg) + "[installOpenDKIM]")
    ...
    def restartServices():
        try:
            ...
            logging.FoxitiCPLogFileWriter.writeToFile(str(msg) + " [restartServices]")
    ...
    def installSpamAssassin(install, SpamAssassin):
        try:
            ...
            if res == 1:
                ...
                writeToFile.writelines("Can not be installed.[404]\n")
                writeToFile.close()
                logging.FoxitiCPLogFileWriter.writeToFile("[Could not Install SpamAssassin.]")
                return 0
            else:
                writeToFile = open(mailUtilities.spamassassinInstallLogPath, 'a')
            ...
            writeToFile.writelines("Can not be installed.[404]\n")
            writeToFile.close()
            logging.FoxitiCPLogFileWriter.writeToFile(str(msg) + "[installSpamAssassin]")
...
"""
            ...
            if res == 1:
                ...
                writeToFile.writelines("Can not be installed.[404]\n")
                writeToFile.close()
                logging.FoxitiCPLogFileWriter.writeToFile("[Could not Install Rspamd.]")
                return 0
            else:
...
"""
            ...
            writeToFile.writelines("Can not be installed.[404]\n")
            writeToFile.close()
            logging.FoxitiCPLogFileWriter.writeToFile(str(msg) + "[installRspamd]")

    @staticmethod
    def uninstallRspamd(install, rspamd):
        from manageServices.serviceManager import ServiceManager
        try:
            logging.FoxitiCPLogFileWriter.writeToFile( "start................[uninstallRspamd]")
            ...
            writeToFile.writelines("Can not be installed.[404]\n")
            writeToFile.close()
            logging.FoxitiCPLogFileWriter.writeToFile(str(msg) + "[uninstallRspamd]")
    ...
    def changeRspamdConfig(install, changeRspamdConfig):
        try:
            ...
            tempfilepath = "/home/foxitipanel/tempfilerspamdconfigs"
            ...
            logging.FoxitiCPLogFileWriter.writeToFile(str(msg) + "[changeRspamdConfig]")
    ...
    def changePostfixConfig(install , changePostfixConfig):
        try:
            tempfilepath = "/home/foxitipanel/tempfilepostfixconfigs"
            file = open(tempfilepath, "r")
            jsondata1 = file.read()
            jsondata = json.loads(jsondata1)
            file.close()
            ...
            logging.FoxitiCPLogFileWriter.writeToFile(str(msg) + "[changePostfixConfig]")
    ...
    def changeRedisxConfig(install, changeRedisxConfig):
        try:
            tempfilepath = "/home/foxitipanel/saveRedisConfigurations"
            file = open(tempfilepath, "r")
            jsondata1 = file.read()
            jsondata = json.loads(jsondata1)
            file.close()
            ...
            logging.FoxitiCPLogFileWriter.writeToFile(str(msg) + "[changeRedisxConfig]")
    ...
    def changeclamavConfig(install, changeclamavConfig):
        try:
            tempfilepath = "/home/foxitipanel/saveclamavConfigurations"
            file = open(tempfilepath, "r")
            jsondata1 = file.read()
            jsondata = json.loads(jsondata1)
            file.close()
            ...
            logging.FoxitiCPLogFileWriter.writeToFile(str(msg) + "[changeclamavConfig]")
    ...
    def installMailScanner(install, SpamAssassin):
        try:
            ...
            if mailUtilities.checkIfSpamAssassinInstalled():
                ...
                command = 'chmod +x /usr/local/FoxitiCP/CPScripts/mailscannerinstaller.sh'
                ProcessUtilities.executioner(command)


                command = '/usr/local/FoxitiCP/CPScripts/mailscannerinstaller.sh'
                ...
                if res == 1:
                    ...
                    writeToFile.writelines("Can not be installed.[404]\n")
                    writeToFile.close()
                    logging.FoxitiCPLogFileWriter.writeToFile("[Could not Install MailScanner.]")
                    return 0
                else:
                    writeToFile = open(mailUtilities.mailScannerInstallLogPath, 'a')
                ...
                writeToFile = open(mailUtilities.mailScannerInstallLogPath, 'a')
                writeToFile.writelines("Please install SpamAssassin from foxitiPanel before installing MailScanner.[404]\n")
                writeToFile.close()
    ...
    def configureSpamAssassin():
        try:
            ...
            logging.FoxitiCPLogFileWriter.writeToFile(str(msg) + " [configureSpamAssassin]")
            print("0," + str(msg))
            return
        except BaseException as msg:
            logging.FoxitiCPLogFileWriter.writeToFile(str(msg) + " [configureSpamAssassin]")
        ...
        try:
            ...
            if install == '1':
                if not os.path.exists('/etc/systemd/system/cpecs.service'):
                    shutil.copy("/usr/local/FoxitiCP/postfixSenderPolicy/cpecs.service", "/etc/systemd/system/cpecs.service")
    ...
    def checkIfMailScannerInstalled():
        try:
            ...
            path = "/usr/local/FoxitiCP/public/mailwatch"
    ...
    def reverse_dns_lookup(ip_address):
        try:
            ...
            fetchURLs = requests.get('https://foxitipanel.net/dnsServers.txt')
            ...
            if fetchURLs.status_code == 200:
                ...
                if os.path.exists(ProcessUtilities.debugPath):
                    logging.FoxitiCPLogFileWriter.writeToFile(f'DNS urls {urls}.')
                ...
                for url in urls:
                    try:
                        ...
                        if os.path.exists(ProcessUtilities.debugPath):
                            logging.FoxitiCPLogFileWriter.writeToFile(f'url to call {ip_address} is {url}')

                        if response.status_code == 200:
                            data = response.json()

                            if os.path.exists(ProcessUtilities.debugPath):
                                logging.FoxitiCPLogFileWriter.writeToFile(f'response from dns system {str(data)}')
                ...
                if os.path.exists(ProcessUtilities.debugPath):
                    logging.FoxitiCPLogFileWriter.writeToFile(f'rDNS result of {ip_address} is {str(results)}')

                ###

                return results
        except BaseException as e:
            logging.FoxitiCPLogFileWriter.writeToFile(f'Error in fetch rDNS {str(msg)}')
    ...
    def configureRelayHost(smtpHost, smtpPort, smtpUser, smtpPassword):
        try:
            ...
            logging.FoxitiCPLogFileWriter.writeToFile(str(msg) + ' [configureRelayHost]')
            print('0,%s' % str(msg))
    ...
    def removeRelayHost():
        try:
            ...
            logging.FoxitiCPLogFileWriter.writeToFile(str(msg) + ' [removeRelayHost]')
            print('0,%s' % str(msg))
...
class MailServerManagerUtils(multi.Thread):
            ...
            try:
                ...
                for items in postFixLines:
                    if items.find('myhostname') > -1 and items[0] != '#':
                        ...
                        if os.path.exists(ProcessUtilities.debugPath):
                            logging.FoxitiCPLogFileWriter.writeToFile(f'Mail server SSL is issued with value: {self.mailHostName}')

                        self.MailSSL = 1
            except BaseException as msg:
                self.MailSSL = 0
                logging.FoxitiCPLogFileWriter.writeToFile('%s. [checkIfMailServerSSLIssued:864]' % (str(msg)))
    ...
    def install_postfix_dovecot(self):
        try:
            ...
            logging.FoxitiCPLogFileWriter.statusWriter(self.extraArgs['tempStatusPath'], 'Re-installing postfix..,10')
            ...
            logging.FoxitiCPLogFileWriter.statusWriter(self.extraArgs['tempStatusPath'], 'Re-installing Dovecot..,15')
    ...
    def setup_email_Passwords(self, mysqlPassword):
        try:
            ...
            mysql_virtual_domains = "/usr/local/FoxitiCP/install/email-configs-one/mysql-virtual_domains.cf"
            mysql_virtual_forwardings = "/usr/local/FoxitiCP/install/email-configs-one/mysql-virtual_forwardings.cf"
            mysql_virtual_mailboxes = "/usr/local/FoxitiCP/install/email-configs-one/mysql-virtual_mailboxes.cf"
            mysql_virtual_email2email = "/usr/local/FoxitiCP/install/email-configs-one/mysql-virtual_email2email.cf"
            dovecotmysql = "/usr/local/FoxitiCP/install/email-configs-one/dovecot-sql.conf.ext"
            ...
            dataWritten = "connect = host=localhost dbname=foxitipanel user=foxitipanel password=" + mysqlPassword + " port=3306\n"
    ...
    def setup_postfix_dovecot_config(self):
        try:
            ...
            if ProcessUtilities.decideDistro() == ProcessUtilities.ubuntu or ProcessUtilities.decideDistro() == ProcessUtilities.ubuntu20:
                self.centos_lib_dir_to_ubuntu("/usr/local/FoxitiCP/install/email-configs-one/master.cf", "/usr/libexec/",
                                              "/usr/lib/")
                self.centos_lib_dir_to_ubuntu("/usr/local/FoxitiCP/install/email-configs-one/main.cf",
                                              "/usr/libexec/postfix",
            ...
            shutil.copy("/usr/local/FoxitiCP/install/email-configs-one/mysql-virtual_domains.cf",
                        "/etc/postfix/mysql-virtual_domains.cf")
            shutil.copy("/usr/local/FoxitiCP/install/email-configs-one/mysql-virtual_forwardings.cf",
                        "/etc/postfix/mysql-virtual_forwardings.cf")
            shutil.copy("/usr/local/FoxitiCP/install/email-configs-one/mysql-virtual_mailboxes.cf",
                        "/etc/postfix/mysql-virtual_mailboxes.cf")
            shutil.copy("/usr/local/FoxitiCP/install/email-configs-one/mysql-virtual_email2email.cf",
                        "/etc/postfix/mysql-virtual_email2email.cf")
            shutil.copy("/usr/local/FoxitiCP/install/email-configs-one/main.cf", main)
            shutil.copy("/usr/local/FoxitiCP/install/email-configs-one/master.cf", master)
            shutil.copy("/usr/local/FoxitiCP/install/email-configs-one/dovecot.conf", dovecot)
            shutil.copy("/usr/local/FoxitiCP/install/email-configs-one/dovecot-sql.conf.ext", dovecotmysql)
            ...
            ## The base foxitiPanel install does not ship pigeonhole, and on some
    ...
    def ResetEmailConfigurations(self):
        try:
            ...
            try:
                ...
                if os.path.exists(ProcessUtilities.debugPath):
                    logging.FoxitiCPLogFileWriter.writeToFile('%s. [setupConnection:75]' % (str(msg)))
            ...
            logging.FoxitiCPLogFileWriter.statusWriter(self.extraArgs['tempStatusPath'], 'Resetting configurations..,40')
            ...
            logging.FoxitiCPLogFileWriter.statusWriter(self.extraArgs['tempStatusPath'], 'Configurations reset..,70')
            ...
            logging.FoxitiCPLogFileWriter.statusWriter(self.extraArgs['tempStatusPath'], 'Fixing permissions..,90')

            self.fixfoxitiPanelPermissions()

            command = '/usr/local/FoxitiCP/bin/python /usr/local/FoxitiCP/dns/dnsManager.py ResetDNSConfigurations --tempStatusPath /home/foxitipanel/dnscheck'
            ProcessUtilities.executioner(command)

            command = 'touch /home/foxitipanel/postfix'
            ProcessUtilities.executioner(command)
