            ...
            for domain in domains_to_scan:
                try:
                    ...
                    class FakeRequest:
                        ...
                        def get_host(self):
                            # Get the hostname from foxitiPanel settings
                            try:
                                from plogical.acl import ACLManager
                                server_ip = ACLManager.fetchIP()
                                return f"{server_ip}:8090"  # Default foxitiPanel port
                            except:
...
View detailed results in your foxitiPanel AI Scanner dashboard.
"""
            
            # Send email using foxitiPanel's email system
            from plogical.mailUtilities import mailUtilities
            sender = 'noreply@foxitipanel.local'
...
Please check your foxitiPanel AI Scanner configuration and try again.
"""
